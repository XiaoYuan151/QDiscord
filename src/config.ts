...
const envSchema = z
  .object({
    ...
    RESOLVE_QQ_MEDIA_URLS: z.string().optional(),
...
export function loadConfig(env: NodeJS.ProcessEnv = process.env): AppConfig {
  ...
  return {
    ...
    resolveQqMediaUrls: parseBoolean(parsed.data.RESOLVE_QQ_MEDIA_URLS, true),
    ...
    queueMaxPending: parsePositiveInteger(parsed.data.QUEUE_MAX_PENDING, 1000),
    ...
    queueRetryJitterMs: parseNonNegativeInteger(parsed.data.QUEUE_RETRY_JITTER_MS, 0),
